...
if __name__ == "__main__":
    ...
    print("\n✓ 动画加载完成！")
    print("  - Idle:    ", len(jin_loader.frames["Idle"]), "帧")
    print("  - Walking: ", len(jin_loader.frames["Walking"]), "帧")
    print("  - Attacking:", len(jin_loader.frames["Attacking"]), "帧")
    print("  - Casting: ", len(jin_loader.frames["Casting"]), "帧")
